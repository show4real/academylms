								...
								<div class="col-xl-3 col-lg-6">
									<div class="card">
										...
										<div class="card-body">
											...
											<button type="button" class="btn btn-icon btn-primary" style="float: right;" id = "btn-<?php echo slugify($key); ?>" onclick="updatePhrase('<?php echo slugify($key); ?>')"> <i class = "mdi mdi-check-circle"></i> </button>
										</div>
									</div>
								</div>
								<?php endforeach; ?>
